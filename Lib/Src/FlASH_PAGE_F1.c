 ...
 * char *data = "hello FLASH from ControllerTech\
    ...
    Flash_Write_Data(0x08009420 , (uint32_t *)data2, 9);
    Flash_Read_Data(0x08009420 , Rx_Data, 10);


    int numofwords = (strlen(data)/4)+((strlen(data)%4)!=0);
    Flash_Write_Data(0x08009500 , (uint32_t *)data, numofwords);
    Flash_Read_Data(0x08009500 , Rx_Data, numofwords);
